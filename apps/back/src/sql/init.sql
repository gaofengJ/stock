...
CREATE TABLE `t_source_daily` (
  ...
  `trade_date` date NOT NULL COMMENT '交易日期',
  `up_limit` decimal(16,2) NOT NULL COMMENT '涨停价(元)',
  `down_limit` decimal(16,2) NOT NULL COMMENT '跌停价(元)',
  `open` decimal(16,2) NOT NULL COMMENT '开盘价(元)',
  `high` decimal(16,2) NOT NULL COMMENT '最高价(元)',
  `low` decimal(16,2) NOT NULL COMMENT '最低价(元)',
  `close` decimal(16,2) NOT NULL COMMENT '收盘价(元)',
  `pre_close` decimal(16,2) NOT NULL COMMENT '昨收价(元)',
  `change` decimal(16,2) NOT NULL COMMENT '涨跌额(元)',
...
CREATE TABLE `t_source_limit` (
  ...
  `close` decimal(16,2) NOT NULL COMMENT '收盘价(元)',
  `pct_chg` decimal(16,2) NOT NULL COMMENT '涨跌幅(%)',
  `amount` decimal(16,2) DEFAULT NULL COMMENT '成交额(元)',
  `limit_amount` decimal(16,2) DEFAULT NULL COMMENT '板上成交额(元)',
  `float_mv` decimal(16,2) DEFAULT NULL COMMENT '流通市值(元)',
  `total_mv` decimal(16,2) DEFAULT NULL COMMENT '总市值(元)',
  `turnover_ratio` decimal(16,2) DEFAULT NULL COMMENT '换手率(%)',
  `fd_amount` decimal(16,2) DEFAULT NULL COMMENT '封单金额(元)',
